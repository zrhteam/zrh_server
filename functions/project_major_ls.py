...
@project_major_ls_blueprint.route('/project_major_ls_info', methods=['POST', 'GET'])
def project_major_ls_info():
    print("In function project_major_ls_info")
    start_t = datetime.now()
    project_name = request.form.get("project_name")
...
# 6.不同风险等级的不同系统下的数量
@project_major_ls_blueprint.route('/project_major_ls_risk_level_system_info', methods=['POST', 'GET'])
def project_major_ls_risk_level_system_info():
    print("In function project_major_ls_risk_level_system_info")
    start_t = datetime.now()
    project_name = request.form.get("project_name")
    major_name = request.form.get("major_name")
    cache_cascade_record = gl.get_value("final_record")
...
# 7.不同分布区域的不同系统下的数量
@project_major_ls_blueprint.route('/project_major_ls_area_system_info', methods=['POST', 'GET'])
def project_major_ls_area_system_info():
    print("In function project_major_ls_area_system_info")
    start_t = datetime.now()
    project_name = request.form.get("project_name")
    major_name = request.form.get("major_name")
    cache_cascade_record = gl.get_value("final_record")
