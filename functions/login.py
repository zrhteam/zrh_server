...
#                                 # print(ele.code)
#                                 # if ele.code in cache_check_location_map.keys():
#                                 value["headquarter_tag"][item.headquarter_tag]["project_tag"][ele.project_tag].append({ele.code: ""})
#                             else:
...
#                                     "project_tag"][ele.project_tag].append({ele.code: ""})
...
#                             # if ele.code in cache_check_location_map.keys():
#                             value["headquarter_tag"][item.headquarter_tag]["region_tag"][item.region_tag]["project_tag"][
#                                 item.project_tag].append({ele.code: ""})
#                 else:
#                     resp_data["code"] = -1
