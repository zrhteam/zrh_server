...
#                             value["headquarter_tag"][ele.headquarter_tag]["region_tag"][ele.region_tag]["project_tag"][
#                                 ele.project_tag].append({ele.project_code: ""})
...
#                                 # print(ele.project_code)
#                                 # if ele.project_code in cache_check_location_map.keys():
#                                 value["headquarter_tag"][item.headquarter_tag]["project_tag"][ele.project_tag].append({ele.project_code: ""})
#                             else:
...
#                                     "project_tag"][ele.project_tag].append({ele.project_code: ""})
...
#                             # if ele.project_code in cache_check_location_map.keys():
#                             value["headquarter_tag"][item.headquarter_tag]["region_tag"][item.region_tag]["project_tag"][
#                                 item.project_tag].append({ele.project_code: ""})
#                 else:
#                     resp_data["code"] = -1
